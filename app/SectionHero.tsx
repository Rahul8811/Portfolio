            ...
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    ...
                    <motion.p
                        ...
                        aria-label="I'm Rahul Sharma. A passionate Game Designer based in Gurgaon, Haryana, India."
                    >
                        I&apos;m Rahul Sharma. A passionate Game Designer and UI/UX Designer From  Gurgaon, Haryana , India.
                    </motion.p>
                </div>
                {/* second */}
